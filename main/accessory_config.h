...
#define ACCESSORY_HA_HOST_MAX_LEN 63
#define ACCESSORY_HA_USERNAME_MAX_LEN 63
#define ACCESSORY_HA_PASSWORD_MAX_LEN 95
#define ACCESSORY_HA_DISCOVERY_PREFIX_MAX_LEN 31
#define ACCESSORY_HA_TOPIC_BASE_MAX_LEN 63
#define ACCESSORY_HA_MIN_INTERVAL_SEC 2
#define ACCESSORY_HA_MAX_INTERVAL_SEC 3600
#define ACCESSORY_HA_DEFAULT_PORT 1883
#define ACCESSORY_HA_DEFAULT_DISCOVERY_PREFIX "homeassistant"
#define ACCESSORY_HA_DEFAULT_TOPIC_BASE "boschldi"
...
typedef struct {
    bool enabled;
    char host[ACCESSORY_HA_HOST_MAX_LEN + 1];
    uint16_t port;
    char username[ACCESSORY_HA_USERNAME_MAX_LEN + 1];
    char password[ACCESSORY_HA_PASSWORD_MAX_LEN + 1];
    char discovery_prefix[ACCESSORY_HA_DISCOVERY_PREFIX_MAX_LEN + 1];
    char topic_base[ACCESSORY_HA_TOPIC_BASE_MAX_LEN + 1];
    uint32_t interval_sec;
} accessory_ha_config_t;
